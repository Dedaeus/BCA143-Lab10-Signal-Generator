...
int main(void)
{
  ...
  {
#ifdef BUSY_WAIT
    tone_play_with_busy_waiting(40000, 1000, wave);
#else
    tone_play_with_interrupt(40000, 1000, wave);
#endif
  }
  /* USER CODE END WHILE */
}
...
static void MX_GPIO_Init(void)
{
  ...
  /* RGB LED pins - active low, start OFF (SET = off) */
  ...
  /* SW1 button on PB2 - input with pull-up */
